...
//				if(column != 8) {
					...
					txtTaskName.setText((String)tblMilestone.getValueAt(row, 1));
					...
					cboMilestone.setSelectedItem(projectName);
...
//        			
//        		}
				pm.setName(txtTaskName.getText().toString());
			

				SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
				String formattedDueDate = sdf.format(txtStartDate.getDate());
				...
				String selectedProject = (String) cboMilestone.getSelectedItem();
...
//					txtShowAll.selectAll();
				...
				String selectedClient = (String) cboMilestone.getSelectedItem();
...
//					// TODO Auto-generated catch block
		...
		lblTaskName_3.setBounds(321, 114, 80, 30);
		formPanel.add(lblTaskName_3);
		
		JLabel lblTaskName_4 = new JLabel("Type");
		lblTaskName_4.setBounds(321, 157, 80, 30);
		formPanel.add(lblTaskName_4);
		
		textDescription = new JTextField();
		textDescription.setBounds(389, 11, 200, 30);
		formPanel.add(textDescription);
	...
	public void showList() {
		...
		try {
			...
			for (TaskModel pm : list) {
				...
				data[5] = getNameById(statusMap, pm.getSts_id());
				data[6] = getNameById(MilestoneMap, pm.getPj_id());
				data[7] = getNameById(AssignedMap, pm.getSts_id());
				data[8] = getNameById(PriorityMap, pm.getPj_id());
				data[9] = getNameById(TypeMap, pm.getSts_id());
